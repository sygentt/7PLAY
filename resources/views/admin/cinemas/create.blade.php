...
@section('page-description', 'Tambah bioskop baru dalam jaringan')
...
<div class="py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="flex mb-6" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <x-heroicon-m-chevron-right class="h-4 w-4 text-gray-400"/>
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Tambah Cinema</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Tambah Cinema Baru</h1>
            <p class="mt-1 text-sm text-gray-600">Buat cinema baru dalam jaringan bioskop</p>
        </div>

        <!-- Form -->
        <div class="bg-white shadow rounded-lg">
            <form action="{{ route('admin.cinemas.store') }}" method="POST" class="divide-y divide-gray-200">
                @csrf
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <ul class="list-disc pl-5 space-y-1">
                                    <li>Pastikan kota sudah tersedia dalam sistem sebelum menambah cinema</li>
                                    <li>Nama cinema harus unik dalam satu kota</li>
                                    <li>Brand akan digunakan untuk filter dan pencarian</li>
                                    <li>Alamat harus lengkap untuk kemudahan customer</li>
                                    <li>Koordinat akan membantu customer menemukan lokasi</li>
                                </ul>
                            </div>
                        </div>
                    </div>
