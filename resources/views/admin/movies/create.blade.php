...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">Tambahkan film baru ke dalam sistem</p>
    </div>

    <!-- Form -->
    <div class="bg-white shadow rounded-lg">
        <form method="POST" action="{{ route('admin.movies.store') }}" class="space-y-6 p-6">
            @csrf
...
<script>
    ...
    // Preview poster when URL is entered
