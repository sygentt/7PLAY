...
<button 
    ...
    class="flex items-center bg-white/90 hover:bg-white text-gray-800 dark:bg-gray-800/80 dark:hover:bg-gray-800 dark:text-gray-100 px-4 py-2 rounded-lg transition-all duration-200 border border-gray-200 dark:border-gray-700"
>
