                ...
                <div id="tab-schedule">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center space-x-4">
                            <!-- All Cinemas Filter -->
                            <button id="filter-brand-all" class="flex items-center bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <button id="filter-brand-xxi" class="bg-black text-white rounded-lg px-4 py-2 text-sm font-medium">
                                Cinema XXI
                            </button>
                        </div>
                        ...
                        <!-- Search -->
                        <div class="relative">
                            <input id="cinema-search-input" type="text" 
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const brandAllBtn = document.getElementById('filter-brand-all');
        const brandXXIBtn = document.getElementById('filter-brand-xxi');
        ...
        function updateQuery(params){
            ...
            Object.keys(params).forEach((key) => {
                const val = (params[key] || '').toString().trim();
                if(val){
        ...
        brandAllBtn?.addEventListener('click', function(){
            updateQuery({ brand: '' });
        });
        brandXXIBtn?.addEventListener('click', function(){
            updateQuery({ brand: 'Cinema XXI' });
        });
        cinemaSearchInput?.addEventListener('keydown', function(e){
            if(e.key === 'Enter'){
                updateQuery({ q: cinemaSearchInput.value });
            }
        });
    });
</script>
